...
import { tailwindStyles } from '../styles.js';
export let Header = _decorate([customElement('app-header')], function (_initialize, _LitElement) {
  class Header extends _LitElement {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    `;
      ...
      value: function disconnectedCallback() {
        ...
        _get(_getPrototypeOf(Header.prototype), "disconnectedCallback", this)();
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        ...
        return [this.heroImageTemplate(), html`
      ...
      value() {
        return () => {
          ...
          if (offset > vh) {
            this.setScrolled(true); // this.heroImage = false;
            // window.removeEventListener('scroll', this.handleScroll);
      ...
      kind: "method",
      key: "setScrolled",
      value: function setScrolled(bool) {
        this.scrolled = bool;
      }
    }]
  };
